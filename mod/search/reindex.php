<?php
	...
	set_page_owner($_SESSION['guid']);
        ...
        $title = elgg_view_title(elgg_echo('search:rebuildtitle'));
...
// really, those need to be made available elsewhere...
	...
	$content .= '<input type="submit" id="reindex-button" value="Reindex all entities" /><BR>' . "\n";
	$content .= '<span id="reindex-working" class="cancel_button">Working...</span>' . "\n";
	...
	page_draw("Search Indicies", elgg_view_layout("two_column_left_sidebar", '', $title . $body));
