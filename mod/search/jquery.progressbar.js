	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '/mod/search/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/mod/search/images/progressbg_red.gif',
									30: '/mod/search/images/progressbg_orange.gif',
									70: '/mod/search/images/progressbg_green.gif'
								},
